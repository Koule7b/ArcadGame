...
public class StepanoviUrovne {
    public static void main(String[] args) {
        ...
        vystavenyLevelu.ulozeniUrovne(0,vytvorUroven1());
        vystavenyLevelu.ulozeniUrovne(1,vytvorUroven2());
        vystavenyLevelu.ulozeniUrovne(2,vytvorUroven3());
    }
    private static Uroven vytvorUroven1() {
        ...
        // lvl.addSilokoule(15, 15, 10);
        //lvl.addSilokoule(25, 15, 10);
